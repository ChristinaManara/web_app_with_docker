<?php
	/**FormAddStudent.php is responsible for adding a student. The teacher-user fills a form with the wanted data to be saved. When the button "add" is clicked then is called the AddStudent.php
     * which performs the required query for adding students. After that the user is redirected to Teachers.php, in order to see the results."*/
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="text-center">
                    <img src="images/student.png" class="avatar img-circle" alt="avatar" height="110" width="120">
                </div>
                </div>
                ...
                <form class="form-horizontal" action="AddStudent.php"  method="post" name="form">
