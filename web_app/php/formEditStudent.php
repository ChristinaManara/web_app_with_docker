<?php
	/**FormEditStudent.php is responsible for editing a specific student. The teacher-user fills a form with the wanted data to be saved. When the button "save changes is clicked then is called the EditStudent.php
     * which performs the required query for editing students. After that the user is redirected to Teachers.php, in order to see the results."*/
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="text-center">
                    <img src="images/myE.png" class="avatar img-circle" alt="avatar" height="110" width="120">
                </div>
                </div>
                ...
                <form class="form-horizontal" action="EditStudent.php"  method="post" name="form">
